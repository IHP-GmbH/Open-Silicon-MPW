...
You can run the DRC/LVS verification using either KLayout (recommended) or
Magic. It is critical to know that the foundry **can reject** designs that
contain errors from [this list](https://github.com/IHP-GmbH/IHP-Open-PDK/blob/main/ihp-sg13g2/libs.tech/klayout/tech/drc/docs/precheck_rules.md).
